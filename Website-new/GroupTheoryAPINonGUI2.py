...
def update_clustering(custom_groups):
    ...
    return group_hierarchy.independent_groups, group_hierarchy.hierarchical_relationships



# Initialize the group hierarchy with loaded data
group_hierarchy = GroupHierarchyWithTreeview(None)
